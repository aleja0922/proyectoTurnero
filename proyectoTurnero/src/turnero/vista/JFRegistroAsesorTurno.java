 ...
 * @author Usuario
 */
public class JFRegistroAsesorTurno extends javax.swing.JFrame {

    /**
     * Creates new form JFRegistroTurno
     */
    public JFRegistroAsesorTurno() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRegistroAsesorTurno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFRegistroAsesorTurno().setVisible(true);
            }
        });
    }
